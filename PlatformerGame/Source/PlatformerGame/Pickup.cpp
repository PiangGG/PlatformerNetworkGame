...
APickup::APickup()
{
	...
	//will trigger overlap events when other objects pass within its radius|当其他对象在其半径内通过时将触发重叠事件
...
void APickup::OnComponentOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
