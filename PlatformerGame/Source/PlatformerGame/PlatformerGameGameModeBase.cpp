...
#include "PlatformerGameGameModeBase.h"
...
APlatformerGameGameModeBase::APlatformerGameGameModeBase()
{
...
void APlatformerGameGameModeBase::Logout(AController* exiting)
{
...
void APlatformerGameGameModeBase::Tick(float DeltaTime)
{
...
UClass* APlatformerGameGameModeBase::GetDefaultPawnClassForController_Implementation(AController* InController)
{
